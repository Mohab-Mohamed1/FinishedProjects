...
__Vectors
        ...
        DCD     NMI_Handler                 ; NMI Handler				2
        DCD     HardFault_Handler           ; Hard Fault Handler		3
        DCD     MemManage_Handler           ; MPU Fault Handler			4
        DCD     BusFault_Handler            ; Bus Fault Handler			5
        DCD     UsageFault_Handler          ; Usage Fault Handler		6
        DCD     0                           ; Reserved					7
        DCD     0                           ; Reserved					8
        DCD     0                           ; Reserved					9
        DCD     0                           ; Reserved					10
        DCD     SVC_Handler                 ; SVCall Handler			11
        DCD     DebugMon_Handler            ; Debug Monitor Handler		12
        DCD     0                           ; Reserved					13
        DCD     PendSV_Handler              ; PendSV Handler			14
        DCD     SysTick_Handler             ; SysTick Handler			15
        DCD     GPIOPortA_Handler           ; GPIO Port A				16
        DCD     GPIOPortB_Handler           ; GPIO Port B				17
        DCD     GPIOPortC_Handler           ; GPIO Port C				18
        DCD     GPIOPortD_Handler           ; GPIO Port D				19
        DCD     GPIOPortE_Handler           ; GPIO Port E				20
        DCD     UART0_Handler               ; UART0 Rx and Tx			21
        DCD     UART1_Handler               ; UART1 Rx and Tx			22
        DCD     SSI0_Handler                ; SSI0 Rx and Tx			23
        DCD     I2C0_Handler                ; I2C0 Master and Slave		24
        DCD     PWM0Fault_Handler           ; PWM 0 Fault				25
        DCD     PWM0Generator0_Handler      ; PWM 0 Generator 0			26
        DCD     PWM0Generator1_Handler      ; PWM 0 Generator 1			27
        DCD     PWM0Generator2_Handler      ; PWM 0 Generator 2			28
        DCD     Quadrature0_Handler         ; Quadrature Encoder 0		29
        DCD     ADC0Seq0_Handler            ; ADC0 Sequence 0			30
        DCD     ADC0Seq1_Handler            ; ADC0 Sequence 1			31
        DCD     ADC0Seq2_Handler            ; ADC0 Sequence 2			32
        DCD     ADC0Seq3_Handler            ; ADC0 Sequence 3			33
        DCD     WDT_Handler                 ; Watchdog					34
        DCD     Timer0A_Handler             ; Timer 0 subtimer A		35
        DCD     Timer0B_Handler             ; Timer 0 subtimer B		36
        DCD     Timer1A_Handler             ; Timer 1 subtimer A		37
        DCD     Timer1B_Handler             ; Timer 1 subtimer B		38
        DCD     Timer2A_Handler             ; Timer 2 subtimer A		39
        DCD     Timer2B_Handler             ; Timer 2 subtimer B		40
        DCD     Comp0_Handler               ; Analog Comp 0				41
        DCD     Comp1_Handler               ; Analog Comp 1				42
        DCD     Comp2_Handler               ; Analog Comp 2				43
        DCD     SysCtl_Handler              ; System Control			44
        DCD     FlashCtl_Handler            ; Flash Control				45
        DCD     GPIOPortF_Handler           ; GPIO Port F				46
        DCD     GPIOPortG_Handler           ; GPIO Port G				47
        DCD     GPIOPortH_Handler           ; GPIO Port H				48
        DCD     UART2_Handler               ; UART2 Rx and Tx			49
        DCD     SSI1_Handler                ; SSI1 Rx and Tx			50
        DCD     Timer3A_Handler             ; Timer 3 subtimer A		51
        DCD     Timer3B_Handler             ; Timer 3 subtimer B		52
        DCD     I2C1_Handler                ; I2C1 Master and Slave		53
        DCD     Quadrature1_Handler         ; Quadrature Encoder 1		54
        DCD     CAN0_Handler                ; CAN0						55
        DCD     CAN1_Handler                ; CAN1						56
        DCD     CAN2_Handler                ; CAN2						57
        DCD     Ethernet_Handler            ; Ethernet					58
        DCD     Hibernate_Handler           ; Hibernate					59
        DCD     USB0_Handler                ; USB0						60
